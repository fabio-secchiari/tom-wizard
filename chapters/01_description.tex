...
\textit{This is ToM+ official user manual hand-written by me (Fabio Java) in English, without using
any AI tool, neither in this guide nor in the code that makes ToM+ work. Other languages
other than English have been automatically translated using} \href{https://www.deepl.com/en/translator}{DeepL}.\\

\textit{In an era of automated content generation, this manual stands apart and you can
be confident that all provided features and user interface are human-written.
This is what makes this project unique among any alternatives: knowing exactly
what the code does is the key to consciously develop new features, fix bugs and
guarantee support to other ToM+ owners if needed.}\\

\textit{ToM+ is costantly evolving with the help of its large community born out from
the} \href{https://www.twizy-forum.de/twiz-o-meter}{German Twizy forum}. \textit{If you 
would like to have a ToM+ unit, email me at} \textbf{info.twizometer@gmail.com}.
\textit{If you would like to suggest a new feature, report a bug or even a typo in this
manual, please email me or open a pull request on} \href{https://codeberg.org/fabio-java/ToM-Wizard}{Codeberg}.\\

\textit{If you own a standard ToM or a BigToM, you can refer to this user manual as well,
since the features are basically the same, except for standard ToM where the dashboard
page and 3D charging pages are missing.}\\

\textit{ToM is not a commercial product and it's handmade by an hobbyst like me, each 
unit is unique and must be considered a prototype, without CE logo or any other 
official tests. Twiz O'meter reads data from the CAN bus without performing any
modifications to the car, but I take no responsibilities for its installation
and usage. I'M ADDING A TEST PHRASE! THE CAT IS ON THE TABLE AND THE DOG IS IN THE BED}\\

\textit{This user manual is updated to 2.4 ESP firmware version at date 03/09/2026.}
...
allow you to mount this app even without an Internet connection. It's available \href{https://www.mediafire.com/file/du7px1bzq0zzdxu/TwizOMeter_v3.1.2.apk/file}{clicking here}.
...
\begin{figure}[H]
    ...
    \caption{The black box}\label{fig:blackbox_components}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Expansion connector}\label{fig:expansion_pinout}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Cable tie}\label{fig:cable_tie}
\end{figure}
