...
your ToM+ in your IoT house. See the Appendix~\ref{apx:tasmota} for detailed configurations. \todo{TODO}\\
...
For more information about tuning your Twizy using Twizy-cfg on ToM+ refer to Appendix~\ref{apx:tuning}. \todo{TODO}
...
desired item numbers (e.g. 59 or 48), one per each, referring to the list in
Section~\ref{sec:icon_list}.\\
...
\subsection{BigToM \textbackslash ToM+ Settings page}
...
or \textit{NOW}, if it has just occurred.
