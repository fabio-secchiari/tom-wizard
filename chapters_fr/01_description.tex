...
\textit{Voici le manuel d'utilisation officiel de ToM+, rédigé à la main par moi-même (Fabio Java) en anglais, sans avoir recours à
...
ce que fait le code est la clé pour développer en toute connaissance de cause de nouvelles fonctionnalités, corriger les bogues et
garantir une assistance aux autres propriétaires de ToM+ si nécessaire.}\\
...
et à son utilisation. J’AJOUTE UNE PHRASE DE TEST ! NI CHAT NI CHIEN N’SONT ADMIS !}\\
...
\section{Principales fonctionnalités du ToM+}

ToM+ dispose de nombreuses fonctions et peut être mis à jour en permanence au fur et à mesure du développement
du micrologiciel. Dans les paragraphes suivants, je vais vous présenter brièvement ses
...
Comme le tableau de bord de notre Twizy n’affiche que quelques valeurs, telles que la vitesse et l’
autonomie restante, j’ai décidé de développer cet écran très pratique, qui affichera bien
...
La page principale est personnalisable et vous pouvez choisir ce qui y sera affiché, tout comme les autres pages que vous pouvez faire défiler à l’aide du bouton que vous pouvez monter sur la tige d’essuie-glace.
...
également mise à jour régulièrement et vous permettra de surveiller les données en temps réel de votre Twizy à l’aide
de votre smartphone. 
...
et ignorez-la (elle fonctionnera parfaitement). Voici un aperçu de la page de recharge et des paramètres de l'application :
...
ToM utilisera l'alimentation par batterie 12 V, prélevée directement sur le connecteur OBD, et
ne consommera pas beaucoup, comme le montrent les mesures ci-dessous.
...
De plus, la fonctionnalité tactile vous permettra d’interagir beaucoup plus facilement avec l’
...
illustré sur l’image ci-contre. En effet, il fournit une alimentation supplémentaire de 5 V provenant
...
la broche 1 (câble jaune) et la broche 2 (câble bleu). Elles peuvent remplir des fonctions d’entrée ou de sortie, selon ce que vous choisirez sur la \textit{« page d’extension »} du serveur web ToM \textbf{. Dans cette dernière version de l’appareil, le connecteur d’extension est intégré au boîtier noir (sans câbles colorés), mais le brochage reste identique.
N’oubliez pas de retirer le capot de protection avant utilisation et de n’utiliser qu’une tension d’entrée de \textbf{3,3 V maximum}. Pour des tensions
supérieures, prévoyez un diviseur de tension adapté.
...
Le support 3D comporte également des trous sur sa base si vous souhaitez le visser sur la boîte à gants. Les autres trous sur le cadre servent à visser le capot arrière afin de maintenir l'écran en place une fois à l'intérieur.
...
Le kit comprend un serre-câble permettant de fixer le support imprimé en 3D du bouton à la manette droite de l'essuie-glace (également fournie). De plus, un autocollant est offert en bonus si vous souhaitez soutenir le projet en le collant quelque part sur votre Twizy.
