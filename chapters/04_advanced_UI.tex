...
\begin{itemize}
    \item \textbf{IR CONTROLLER}: This mode allows ToM+ to be controlled by an infrared remote. \todo{TODO}
    \item \textbf{KEY+ CONTROLLER}: This mode allows you to control your ToM+ via a physical button connected to the expansion port.
    \item \textbf{SERIAL TX}: This mode allows you to configure a serial trasmission line on this pin.
    \item \textbf{SERIAL RX}: This mode allows you to configure a serial reception line on this pin.
    \item \textbf{CTRL BUTTON}: This mode allows you to use the right wiper stalk button as a control button for your ToM+.
\end{itemize}
...
As you can see in the image below, when selecting the \textbf{“OUTPUT”} mode, you can choose
...
\begin{itemize}
    ...
    \item \textit{“Charger auxilliary fan”}: This lets you control an auxilliary fan. \todo{TODO}
    \item \textit{“Reku break light”}: This lets you connect a relay board which controls the breaking light, in order to power it on when in regeneration mode. This is particularly useful if you tuned your Twizy to increase the regeneration power.
    \item \textit{“Auxilliary charger”}: This lets you control an auxilliary charger.
    \item \textit{“Motor fan”}: This lets you control a motor fan.
\end{itemize}
...
The second table works the same but it's intended for PIN2 of the expansion connector.
After any change, press the \textbf{“SAVE”} button to save your changes, otherwise they will be lost when you leave the page.
